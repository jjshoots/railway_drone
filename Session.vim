...
badd +11 src/ai_lib/normal_inverse_gamma.py
badd +15 src/ai_lib/trackNet.py
badd +110 src/ai_lib/helpers.py
badd +9 src/utility/shebangs.py
...
setlocal fdn=20
setlocal nofen
let s:l = 95 - ((11 * winheight(0) + 22) / 44)
